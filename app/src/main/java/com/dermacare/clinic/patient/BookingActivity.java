...
public class BookingActivity extends AppCompatActivity {
    ...
    private com.google.android.material.button.MaterialButton btnNext, btnPrev, btnConfirmBooking;
                    ...
                    .enqueue(new retrofit2.Callback<List<ScheduleResponse>>() {
                        ...
                        public void onResponse(retrofit2.Call<List<ScheduleResponse>> call,
                            ...
                            if (response.isSuccessful() && response.body() != null) {
                                scheduleAdapter = new ScheduleAdapter(response.body(), schedule -> {
                                    selectedSchedule = schedule;
                                });
                                rv.setAdapter(scheduleAdapter);
                            }
    ...
    private void goToStep2() {
        ...
        TextView step2Text = stepCircle2.getChildAt(0) instanceof TextView
                ? (TextView) stepCircle2.getChildAt(0) : null;
        if (step2Text != null) step2Text.setTextColor(getColor(R.color.white));
    ...
    private void submitBooking() {
        ...
        btnConfirmBooking.setText("Đang gửi...");

        com.dermacare.clinic.data.api.model.AppointmentRequest req =
                new com.dermacare.clinic.data.api.model.AppointmentRequest(
